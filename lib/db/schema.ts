import { mysqlTable, varchar, text, datetime, boolean, decimal } from "drizzle-orm/mysql-core";
...
export const services = mysqlTable("services", {
	...
	stock: decimal("stock", { precision: 10, scale: 0 }).default("100"), // Total available keys/slots
